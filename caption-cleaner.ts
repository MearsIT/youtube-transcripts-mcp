 ...
 */
export async function cleanVttFile(inputFile: string, outputFile?: string): Promise<string[]> {
  const logger = {
 ...
 */
export function joinCaptions(captions: string[], separator: string = ' '): string {
 ...
 */
export function getCaptionStats(captions: string[]): {
  totalLines: number;
  totalWords: number;
