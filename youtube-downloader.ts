 ...
 */
export async function downloadYouTubeCaptions(url: string, outputDir?: string): Promise<string> {
  const logger = {
 ...
 */
async function cleanupSessionDirectory(sessionDir: string): Promise<void> {
  try {
